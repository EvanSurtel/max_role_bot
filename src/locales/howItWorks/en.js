module.exports = {
  ...
  wallet: {
    ...
    description: [
      ...
      '• Click **Copy Address** to copy it, then paste it into your exchange app (we recommend **Kraken** — lowest fees) when you want to deposit USDC or SOL.',
      '',
      '⚠️ **IMPORTANT — this address ONLY accepts USDC and SOL on the Solana network.**',
      '',
      'When you send USDC or SOL from an exchange (we recommend **Kraken** — lowest fees) or any other wallet app, it will ask you **which network** you want to send it on. You **MUST** choose **Solana network**. If you pick the wrong network — or send a different coin like Bitcoin or Ethereum — **your money will be LOST FOREVER** and we cannot get it back.',
      '',
      'Do NOT send:',
  ...
  funding: {
    ...
    description: [
      ...
      'We recommend **Kraken** — it has the **lowest fees** of any major exchange and supports USDC on the Solana network. Available in the US, Canada, Europe, UK, Japan, Australia, and most other countries.',
      '',
      'If Kraken isn\'t available where you live, any exchange that lets you buy and send **USDC on the Solana network** will work.',
      '',
  ...
  tips: {
    ...
    description: [
      ...
      'A: We recommend **Kraken** — it has the **lowest fees** of any major exchange and supports USDC on the Solana network. If Kraken isn\'t available in your country, any exchange that lets you buy and send USDC on the **Solana network** will work.',
      '',
