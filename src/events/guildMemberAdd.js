...
module.exports = {
  ...
  async execute(member) {
    ...
    // No auto-wallet creation on join. Self-custody wallets are created
    // by the user in their own browser via the /setup web surface,
    // triggered either by registration completion or by the demo-channel
    // auto-provision fallback. Nothing to do here beyond the rank
    // resync above.
  },
};
