...
function buildHowItWorksPanel() {
  ...
  const xpEmbed = new EmbedBuilder()
    ...
    .setDescription([
      ...
      '',
      '**XP Challenges** use an ELO system:',
      '• Beat a stronger team → earn more XP',
      '• Beat a weaker team → earn less XP',
      '• Lose to a stronger team → lose less XP',
      '',
      '**XP Queue** gives a fixed amount:',
      '• Win: +100 XP',
      '• Loss: -60 XP',
      '',
      '**Wager wins** also give XP scaled to how much you wagered — bigger wager = more XP.',
      '',
